...
<div class="container my-4">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-warning">
            <h5 class="mb-0">
                <i class="bi bi-pencil"></i> Chỉnh sửa Size
            </h5>
        </div>
        <div class="card-body">

            <form action="{{ route('admin.size.update', $size->Ma_Size) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('Nhom_Size') is-invalid @enderror" 
                            ...
                            name="Nhom_Size" 
                            rows="3" 
                            placeholder="VD: Size người lớn...">{{ old('Nhom_Size', $size->Nhom_Size) }}</textarea>
